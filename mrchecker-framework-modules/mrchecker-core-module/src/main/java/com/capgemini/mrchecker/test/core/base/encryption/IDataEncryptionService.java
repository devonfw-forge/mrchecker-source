...
public interface IDataEncryptionService {
     ...
     * @throws BFSecureModuleException in case of encryption problems.
     */
     ...
     * cipher text.
     *
     * @param text decorated cipher text.
     * @return decrypted text as string.
     * @throws BFSecureModuleException in case of decryption problems.
     */
    String decrypt(String text) throws BFSecureModuleException;

    /**
     * @param text plain text or cipher text.
     ...
     *
     * @param secret secret to be used for data encryption/decryption. NOTE: "password1" is a bad
     *               secret. Something like "IM%&@N8932m>|j9123nG&kyYWB" is.
     * @throws BFSecureModuleException error setting the secret value (usually quality
