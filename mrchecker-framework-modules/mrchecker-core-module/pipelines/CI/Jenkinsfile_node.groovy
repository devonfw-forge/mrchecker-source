node(){
	...
	properties([
		parameters([
			string(defaultValue: 'mrchecker-framework-modules/mrchecker-core-module/', description: 'Execute job for given Module. Example mrchecker-framework-modules/mrchecker-core-module/ ', name: 'APP_WORKSPACE'),
