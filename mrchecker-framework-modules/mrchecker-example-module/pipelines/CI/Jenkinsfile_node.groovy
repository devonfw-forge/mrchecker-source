node(){
	...
	properties([
		parameters([
			string(defaultValue: 'mrchecker-framework-modules/mrchecker-example-module/', description: 'Execute job for given Module. Example mrchecker-framework-modules/mrchecker-example-module/ ', name: 'APP_WORKSPACE'),
