node(){
	...
	properties([
		parameters([
			string(defaultValue: 'mrchecker-framework-modules/mrchecker-database-module/', description: 'Execute job for given Module. Example mrchecker-framework-modules/mrchecker-database-module/ ', name: 'APP_WORKSPACE'),
