...
public class WdUtility {
     ...
     *
     * @param driver
     * @param querySelector - e.g. .balances--download-balances
     * @param pseudoElement - e.g. :before
     * @param cssProperty   - e.g. content
     * @return
     */
     ...
     * @param text     text to look for inside the element
     ...
     * @param tooltip tooltip to be displayed upon hover
     ...
     *
     * @param element element to be hovered
     * @param tooltip selector to be displayed upon hover
     * @return true if tooltip is displayed, false otherwise
     * @author
     */
     ...
     *
     * @param selector selector for element
     * @param format   format which the text should match
    ...
    /**
     * @param selectorKey   selector for all key elements
     * @param selectorValue selector for all value elements
    ...
    /**
     * @param element 's selector as a string
    ...
    /**
     * @param selectorElement selector for element
     * @param expectedText    text to look for inside the element
