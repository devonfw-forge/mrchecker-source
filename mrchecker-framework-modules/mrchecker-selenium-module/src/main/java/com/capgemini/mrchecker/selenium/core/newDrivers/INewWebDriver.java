...
public interface INewWebDriver extends WebDriver {
     ...
     * e.g. PopUp
     *
     * @param elementToSearchIn  elementToSearchIn
     * @param searchedBySelector searchedBySelector
     ...
     * @throws BFElementNotFoundException BFElementNotFoundException BFElementNotFoundException
     */
    WebElement findElementDynamic(By by, Duration timeOut) throws BFElementNotFoundException;
     ...
     */
    List<WebElement> findElementDynamics(By by, Duration timeOut);
     ...
     *
     * @param sliderContainerSelector sliderContainerSelector
     ...
     *
     * @param sliderContainerSelector sliderContainerSelector
     * @param sliderSelector          sliderSelector
