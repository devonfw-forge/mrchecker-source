...
public class WindowUtils {
     ...
     *
     * @param url              - url which you want to get driver
     * @param switchToGivenURL - true if you want switch on this window, false if the another one
     */
     ...
     *
     * @param title         - title/part of title, at which you want to get driver
     * @param switchToGiven - true if you want switch on this window, false if the another one
     */
