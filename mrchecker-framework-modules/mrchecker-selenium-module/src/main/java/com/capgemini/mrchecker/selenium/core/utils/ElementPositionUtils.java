...
public class ElementPositionUtils {
     ...
     *
     * @param selectorFirst  By object with an selector
     * @param selectorSecond By object with an selector
     * @param position       relation of a second element to first one
     ...
     * @param selectorFirst  By object with an selector
     * @param selectorSecond By object with an selector
     * @param scope          WebElement which contains comparing objects
     * @param position       relation of a second element to first one
     * @return true if two elements are placed in given relation
     * @throws BFElementNotFoundException if elements do not exist
     */
    public static boolean isElementsPositionRelatedX(By selectorFirst,
                                                     By selectorSecond,
                                                     WebElement scope,
     ...
     * Method checks if second element is in given relation to first element considering Y coordinate
     *
     * @param elementFirst  first WebElement
     * @param elementSecond second WebElement
     * @param position      relation of a second element to first one
     * @return true if two elements are placed in given relation
     */
