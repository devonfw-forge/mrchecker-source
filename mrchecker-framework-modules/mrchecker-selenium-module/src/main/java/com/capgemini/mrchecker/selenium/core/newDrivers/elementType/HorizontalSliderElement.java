...
public class HorizontalSliderElement extends BasicElement {
     ...
     * </p>
     *
     * @param position A destination value of slider's position.
     * @param method   The way to perform slider's movement:
     *                 <ul>
     *                 <li>0 - KEYBOARD
     *                 <li>1 - MOUSE
     *                 </ul>
     ...
     * </p>
     *
     * @param position Given value of slider's position.
