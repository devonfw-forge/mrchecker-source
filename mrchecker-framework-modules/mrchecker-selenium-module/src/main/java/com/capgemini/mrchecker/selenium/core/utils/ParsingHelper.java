...
public class ParsingHelper {
     ...
     *
     * @param by                               object with location of the WebElement to be parsed.
     * @param returnZeroIfContentIsNotParsable boolean flag: if true - returns zero if the content does not contain a parsable integer; if false -
     *                                         throws NumberFormatException if the content does not contain a parsable integer
     * @return int with parsed value.
     * @throws NumberFormatException if the content does not contain a parsable integer and the returnZeroIfContentIsNotParsable flag
     *                               is set to false.
     * @author
     */
     ...
     *
     * @param stringToParse String to be parsed.
     * @return int with parsed value.
     ...
     *
     * @param stringToParse String to be parsed.
     * @param regexToSearch pattern of the substring, which should be parsed
