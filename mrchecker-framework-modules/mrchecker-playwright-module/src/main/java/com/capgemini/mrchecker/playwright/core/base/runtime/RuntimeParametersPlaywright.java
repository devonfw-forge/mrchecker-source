package com.capgemini.mrchecker.playwright.core.base.runtime;
 ...
 * @author MBABIARZ
 */
public enum RuntimeParametersPlaywright implements IRuntimeParameters {
    ...
    RuntimeParametersPlaywright(String paramName, String defaultValue) {
