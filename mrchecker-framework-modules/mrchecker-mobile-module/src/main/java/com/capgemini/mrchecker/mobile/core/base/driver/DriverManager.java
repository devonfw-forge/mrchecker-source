...
public class DriverManager {
    ...
    private static final ThreadLocal<INewMobileDriver> drivers = new ThreadLocal<>();
    ...
    // default:
    // throw new RuntimeException("Unable to setup [" + device + "] device. Name not recognized. Possible values:
    // android, ios, windows");
    // }
    // }
    ...
    private enum Driver {
        ...
        //
        //// AndroidCreateWebSessionTest
        // https://github.com/appium/appium/blob/master/sample-code/java/src/AndroidCreateWebSessionTest.java
        //// DesiredCapabilities capabilities = new DesiredCapabilities();
        //// capabilities.setCapability("deviceName", "Android Emulator");
        ...
        // https://github.com/appium/appium/blob/master/sample-code/java/src/IOSCreateSessionTest.java
        // // File classpathRoot = new File(System.getProperty("user.dir"));
        // // File appDir = new File(classpathRoot, "../apps");
        ...
        // https://github.com/appium/appium/blob/master/sample-code/java/src/IOSCreateWebSessionTest.java
        // // String deviceName = System.getenv("IOS_DEVICE_NAME");
        // // String platformVersion = System.getenv("IOS_PLATFORM_VERSION");
        // // DesiredCapabilities capabilities = new DesiredCapabilities();
        // // capabilities.setCapability("deviceName", deviceName == null ? "iPhone 6s" : deviceName);
        ...
        //
        // DesiredCapabilities capabilities = new DesiredCapabilities();
        // capabilities.setCapability(RuntimeParameters.AUTOMATION_NAME.getKey(),
        // RuntimeParameters.AUTOMATION_NAME.getValue());
        // capabilities.setCapability(RuntimeParameters.PLATFORM_NAME.getKey(),
        // RuntimeParameters.PLATFORM_NAME.getValue());
        // capabilities.setCapability(RuntimeParameters.PLATFORM_VERSION.getKey(),
        // RuntimeParameters.PLATFORM_VERSION.getValue());
        ...
        // capabilities.setCapability(RuntimeParameters.BROWSER_NAME.getKey(),
        // RuntimeParameters.BROWSER_NAME.getValue());
        //
    ...
    private static class DriverManagerForAppium implements IDriverManager {
        ...
        public DesiredCapabilities getCapabilities() {
            DesiredCapabilities capabilities = new DesiredCapabilities();
            RuntimeParameters[] capsToSet = {RuntimeParameters.AUTOMATION_NAME, RuntimeParameters.PLATFORM_NAME, RuntimeParameters.PLATFORM_VERSION,
                    RuntimeParameters.DEVICE_NAME, RuntimeParameters.APP, RuntimeParameters.BROWSER_NAME};
            Arrays.stream(capsToSet)
    ...
    private static class DriverManagerForAndroid extends DriverManagerForAppium implements IDriverManager {
        ...
        @Override
        public NewAndroidDriver getDriver() {
            return null;
        }
